...
#
# Generated by export_simulation on Wed May 24 18:55:50 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './gray_linebuffer.sh' script.

./gray_linebuffer.sh -reset_run
...
./gray_linebuffer.sh -noclean_files

For more information on the script, please type './gray_linebuffer.sh -help'.
