...
#
# Generated by export_simulation on Sat Jun 03 14:55:51 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './conv2_linebuffer.sh' script.

./conv2_linebuffer.sh -reset_run
...
./conv2_linebuffer.sh -noclean_files

For more information on the script, please type './conv2_linebuffer.sh -help'.
