...
#
# Generated by export_simulation on Sat May 13 21:06:12 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './c1_b_rom.sh' script.

./c1_b_rom.sh -reset_run
...
./c1_b_rom.sh -noclean_files

For more information on the script, please type './c1_b_rom.sh -help'.
