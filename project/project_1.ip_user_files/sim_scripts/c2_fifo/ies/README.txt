...
#
# Generated by export_simulation on Sat Jun 03 17:16:16 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './c2_fifo.sh' script.

./c2_fifo.sh -reset_run
...
./c2_fifo.sh -noclean_files

For more information on the script, please type './c2_fifo.sh -help'.
