...
#
# Generated by export_simulation on Sat Jun 03 17:31:50 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './p2_linebuffer.sh' script.

./p2_linebuffer.sh -reset_run
...
./p2_linebuffer.sh -noclean_files

For more information on the script, please type './p2_linebuffer.sh -help'.
