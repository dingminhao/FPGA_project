...
#
# Generated by export_simulation on Sat Jun 03 14:47:00 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './c2_w_row1.sh' script.

./c2_w_row1.sh -reset_run
...
./c2_w_row1.sh -noclean_files

For more information on the script, please type './c2_w_row1.sh -help'.
