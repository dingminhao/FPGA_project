...
#
# Generated by export_simulation on Sat Jun 03 14:50:57 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './c2_w_row3.sh' script.

./c2_w_row3.sh -reset_run
...
./c2_w_row3.sh -noclean_files

For more information on the script, please type './c2_w_row3.sh -help'.
