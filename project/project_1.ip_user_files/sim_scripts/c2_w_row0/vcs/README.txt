...
#
# Generated by export_simulation on Sat Jun 03 14:43:34 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './c2_w_row0.sh' script.

./c2_w_row0.sh -reset_run
...
./c2_w_row0.sh -noclean_files

For more information on the script, please type './c2_w_row0.sh -help'.
