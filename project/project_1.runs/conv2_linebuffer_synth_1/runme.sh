...
HD_PWD='C:/Users/DMH/Desktop/project/project_1.runs/conv2_linebuffer_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log conv2_linebuffer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source conv2_linebuffer.tcl
