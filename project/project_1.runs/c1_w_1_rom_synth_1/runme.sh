...
HD_PWD='C:/Users/DMH/Desktop/project/project_1.runs/c1_w_1_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log c1_w_1_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source c1_w_1_rom.tcl
