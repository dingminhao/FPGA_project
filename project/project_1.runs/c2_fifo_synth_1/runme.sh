...
HD_PWD='C:/Users/DMH/Desktop/project/project_1.runs/c2_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log c2_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source c2_fifo.tcl
