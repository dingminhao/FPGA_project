...
#
# Generated by export_simulation on Thu Jan 12 22:14:13 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './axi_full_0.sh' script.

./axi_full_0.sh -reset_run
...
./axi_full_0.sh -noclean_files

For more information on the script, please type './axi_full_0.sh -help'.
