...
HD_PWD='C:/Users/DMH/Desktop/summerysyx/mul_div/wallance_all/wallance/wallance.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ysyx_alu_mul_slow.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ysyx_alu_mul_slow.tcl
