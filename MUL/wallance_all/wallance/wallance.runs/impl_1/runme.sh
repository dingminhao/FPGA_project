...
HD_PWD='C:/Users/DMH/Desktop/summerysyx/mul_div/wallance_all/wallance/wallance.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ysyx_alu_mul_slow.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ysyx_alu_mul_slow.tcl -notrace
